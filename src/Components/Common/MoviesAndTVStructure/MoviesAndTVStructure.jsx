...
const MoviesAndTVStructure = ({ frameName, children }) => {
  return (
    <section className="FrameWrap pb-4 my-18">
      <div className="outerBox border relative rounded-md border-gray-15">
        <div className="absolute left-3 -top-4 w-fit flex justify-center items-center text-white bg-red-45 px-3 py-1 rounded-md">
