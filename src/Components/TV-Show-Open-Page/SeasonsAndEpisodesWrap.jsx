                  ...
                  {openSeason === s.season_number && (
                    ...
                    >
                      {s.episodes.map((ep) => (
                        <li
                          key={ep.id}
                          className="episodeList flex-col flex gap-2 px-2 py-2 border-b border-gray-15 last:border-0"
                        >
                          <div className="episodeNumberAndPoster flex items-center justify-between">
                            ...
                            <div className="episodeNumber flex items-center justify-center w-full">
                          ...
                          <div className="EpisodeLength border border-gray-15 rounded-md w-fit text-sm text-gray-65 flex gap-1 items-center p-1">
                            <IoTimeOutline />
                            <p>{ep.runtime} Min</p>
                          </div>

                          <div className="episodeName px-1 text-white">
